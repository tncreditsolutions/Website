              ...
              messages: [
                {
                  ...
                  content: [
                    ...
                    {
                      type: "text",
                      text: "You are a professional financial advisor. Analyze this credit report and create a BEAUTIFUL, VISUALLY STRIKING summary. Use this exact format with proper spacing and structure:\n\n═══════════════════════════════════════════════════════\n✦ CREDIT ANALYSIS SUMMARY\n═══════════════════════════════════════════════════════\n\n┌─ CURRENT STATUS\n│  📊 Credit Score: [exact score]\n│  🎯 Risk Level: [HIGH/MEDIUM/LOW]\n│  ⚠️  Key Issue: [main problem]\n└─\n\n┌─ TOP PRIORITY ACTIONS\n│  1️⃣  [Critical issue] → Impact: [specific impact]\n│  2️⃣  [Second issue] → Impact: [specific impact]\n│  3️⃣  [Third issue] → Impact: [specific impact]\n└─\n\n┌─ PAYMENT HISTORY BREAKDOWN\n│  ❌ Late Payments: [count] accounts\n│  ✅ On-Time Payments: [count] accounts\n│  📈 Trend: [improving/declining/stable]\n└─\n\n┌─ CREDIT UTILIZATION\n│  💳 Current: [%]\n│  🎯 Recommended: 30% or less\n│  📋 Action: [specific steps to reduce]\n└─\n\n┌─ COLLECTIONS & NEGATIVE MARKS\n│  🚨 Collections: [count]\n│  📌 Derogatory Items: [list specifics]\n│  📅 Timeline: [when recorded/will expire]\n└─\n\n┌─ NEXT 30 DAYS - QUICK WINS\n│  • [Specific action 1] - Due: [timeframe]\n│  • [Specific action 2] - Due: [timeframe]\n│  • [Specific action 3] - Due: [timeframe]\n└─\n\n┌─ 90-DAY RECOVERY PLAN\n│  Week 1-2: [Focus area]\n│  Week 3-8: [Focus area]\n│  Week 9-12: [Expected improvement]\n└─\n\n═══════════════════════════════════════════════════════\n💡 Ready to take action? I'm here to help every step.\n═══════════════════════════════════════════════════════\n\nExtract ACTUAL data from the report image. Use REAL numbers, dates, and account details. Make it visually beautiful with the formatting above.",
                    },
                  ],
                },
              ],
